...
#Logic tests:
  ...
  #ordered_date is not required anymore
...
#    When POST to MATCH patients service, response includes "Assay ordered date earlier than slide shipment date" with status "Failure"#
