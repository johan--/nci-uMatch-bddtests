...
#      | PT_VC15_PathDoneOneAssayVRUploaded       | PT_VC15_PathDoneOneAssayVRUploaded_ANI1       | confirm   | TISSUE_VARIANT_REPORT_CONFIRMED |
  ...
  Scenario Outline: PT_VC18. confirmed assignment report can be rolled back using variant report rollback service and redo the assignment should have same result
    ...
    Examples:
      ...
      | PT_VC18_PendingConfirmation | 1     | APEC1621-A     |            |            |                |            |
      | PT_VC18_PendingApproval     | 1     | APEC1621-A     |            |            |                |            |
      | PT_VC18_PendAppr3Assigns    | 3     | APEC1621-ETE-C | APEC1621-A | 100        | APEC1621-ETE-A | 100        |
