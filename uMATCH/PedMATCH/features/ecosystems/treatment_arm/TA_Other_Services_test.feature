...
Feature: Treatment Arm API Tests that focus on treatment arm api service other than /treatmentArms and /newTreatmentArm
  ...
  Scenario: TA_OS6. /treatmentArm/id return the latest treatment arm, regarless stratum_id
    Given template json with an id: "APEC1621-OS6-1", stratum_id: "STRATUM1" and version: "2016-06-03"
    Then posted to MATCH newTreatmentArm
    Then success message is returned:
    Then wait for "5" seconds
    Then template json with an id: "APEC1621-OS6-1", stratum_id: "STRATUM1" and version: "2016-06-15"
    Then posted to MATCH newTreatmentArm
    Then success message is returned:
    Then wait for "5" seconds
    Then template json with an id: "APEC1621-OS6-1", stratum_id: "STRATUM2" and version: "2016-06-15"
    Then posted to MATCH newTreatmentArm
    Then success message is returned:
  ...
  Scenario: TA_OS7. /treatmentArm/id/stratumId return the latest version of treatment arm
    Given template json with an id: "APEC1621-OS7-1", stratum_id: "STRATUM1" and version: "2016-06-03"
    Then posted to MATCH newTreatmentArm
    Then success message is returned:
    Then wait for "5" seconds
    Then template json with an id: "APEC1621-OS7-1", stratum_id: "STRATUM1" and version: "2016-06-15"
    Then posted to MATCH newTreatmentArm
    Then success message is returned:
    Then wait for "5" seconds
    Then template json with an id: "APEC1621-OS7-1", stratum_id: "STRATUM2" and version: "2016-06-15"
    Then posted to MATCH newTreatmentArm
    Then success message is returned:
