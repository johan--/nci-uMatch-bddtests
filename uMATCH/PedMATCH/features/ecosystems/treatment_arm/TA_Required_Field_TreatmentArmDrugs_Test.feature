...
Feature: Treatment Arm API Tests that focus on "treatmentArmDrugs" field
  ...
  Scenario: New Treatment Arm with incompleted drug entity should fail
  ...
  Scenario: Update Treatment Arm with incompleted drug entity should fail
  Scenario: Drugs should have unique drugId
  Scenario: Unrelated fields in "treatmentArmDrugs" should be ignored
  Scenario: Unrelated fields in drug entity should be ignored
