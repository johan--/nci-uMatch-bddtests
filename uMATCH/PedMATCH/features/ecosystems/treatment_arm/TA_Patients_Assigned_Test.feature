@treatment_arm
Feature: TA_ST. Treatment Arm API Tests that focus on assigment records
#  @treatment_arm_p2
#  Scenario Outline: TA_AS01. statistic numbers update properly (PENDING_CONFIRMATION to PENDING_APPROVAL)
#    Examples:
