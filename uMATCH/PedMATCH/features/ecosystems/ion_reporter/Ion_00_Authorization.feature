...
Feature: ir ecosystem authorization tests
  ...
  Scenario Outline: ION_AU07 role base authorization works properly to update sample_control
    ...
    Given molecular id is "SC_DTM01"
    Then add field: "qc_name" value: "IR_1H9XW/SC_DTM01/SC_DTM01_ANI1/test.pdf" to message body
    Then add field: "site" value: "dartmouth" to message body
  ...
  Scenario Outline: ION_AU08 role base authorization works properly to delete sample_control
    ...
    Examples:
      ...
      | NO_TOKEN                          | SC_MDA00 |         | 401      | SC_MCA00  |           | 401        | SC_DTM00      |               | 401            |
      | NCI_MATCH_READONLY                | SC_MDA00 |         | 401      | SC_MCA00  |           | 401        | SC_DTM00      |               | 401            |
      | NO_ROLE                           | SC_MDA00 |         | 401      | SC_MCA00  |           | 401        | SC_DTM00      |               | 401            |
      | ADMIN                             | SC_MDA02 | deleted | 200      | SC_MCA02  | deleted   | 200        | SC_DTM02      | deleted       | 200            |
      | SYSTEM                            | SC_MDA00 |         | 401      | SC_MCA00  |           | 401        | SC_DTM00      |               | 401            |
      | ASSIGNMENT_REPORT_REVIEWER        | SC_MDA00 |         | 401      | SC_MCA00  |           | 401        | SC_DTM00      |               | 401            |
      | MDA_VARIANT_REPORT_SENDER         | SC_MDA00 |         | 401      | SC_MCA00  |           | 401        | SC_DTM00      |               | 401            |
      | MDA_VARIANT_REPORT_REVIEWER       | SC_MDA00 |         | 401      | SC_MCA00  |           | 401        | SC_DTM00      |               | 401            |
      | MOCHA_VARIANT_REPORT_SENDER       | SC_MDA00 |         | 401      | SC_MCA00  |           | 401        | SC_DTM00      |               | 401            |
      | MOCHA_VARIANT_REPORT_REVIEWER     | SC_MDA00 |         | 401      | SC_MCA00  |           | 401        | SC_DTM00      |               | 401            |
      | DARTMOUTH_VARIANT_REPORT_SENDER   | SC_MDA00 |         | 401      | SC_MCA00  |           | 401        | SC_DTM00      |               | 401            |
      | DARTMOUTH_VARIANT_REPORT_REVIEWER | SC_MDA00 |         | 401      | SC_MCA00  |           | 401        | SC_DTM00      |               | 401            |
      | PATIENT_MESSAGE_SENDER            | SC_MDA00 |         | 401      | SC_MCA00  |           | 401        | SC_DTM00      |               | 401            |
      | SPECIMEN_MESSAGE_SENDER           | SC_MDA00 |         | 401      | SC_MCA00  |           | 401        | SC_DTM00      |               | 401            |
      | ASSAY_MESSAGE_SENDER              | SC_MDA00 |         | 401      | SC_MCA00  |           | 401        | SC_DTM00      |               | 401            |
  ...
  Scenario Outline: ION_AU10 role base authorization works properly to update aliquot
    ...
    Examples:
      ...
      | NCI_MATCH_READONLY                | SC_MDA00 |              | 401      | SC_MCA00  |              | 401        | SC_DTM00      |               | 401            |
      | NO_ROLE                           | SC_MDA00 |              | 401      | SC_MCA00  |              | 401        | SC_DTM00      |               | 401            |
      | ADMIN                             | SC_MDA06 | Item updated | 200      | SC_MCA06  | Item updated | 200        | SC_DTM06      | Item updated  | 200            |
      | SYSTEM                            | SC_MDA07 | Item updated | 200      | SC_MCA07  | Item updated | 200        | SC_DTM07      | Item updated  | 200            |
      | ASSIGNMENT_REPORT_REVIEWER        | SC_MDA00 |              | 401      | SC_MCA00  |              | 401        | SC_DTM00      |               | 401            |
      | MDA_VARIANT_REPORT_SENDER         | SC_MDA08 | Item updated | 200      | SC_MCA00  |              | 401        | SC_DTM00      |               | 401            |
      | MDA_VARIANT_REPORT_REVIEWER       | SC_MDA09 | Item updated | 200      | SC_MCA00  |              | 401        | SC_DTM00      |               | 401            |
      | MOCHA_VARIANT_REPORT_SENDER       | SC_MDA00 |              | 401      | SC_MCA08  | Item updated | 200        | SC_DTM00      |               | 401            |
      | MOCHA_VARIANT_REPORT_REVIEWER     | SC_MDA00 |              | 401      | SC_MCA09  | Item updated | 200        | SC_DTM00      |               | 401            |
      | DARTMOUTH_VARIANT_REPORT_SENDER   | SC_MDA00 |              | 401      | SC_MCA00  |              | 401        | SC_DTM08      | Item updated  | 200            |
      | DARTMOUTH_VARIANT_REPORT_REVIEWER | SC_MDA00 |              | 401      | SC_MCA00  |              | 401        | SC_DTM09      | Item updated  | 200            |
      | PATIENT_MESSAGE_SENDER            | SC_MDA00 |              | 401      | SC_MCA00  |              | 401        | SC_DTM00      |               | 401            |
      | SPECIMEN_MESSAGE_SENDER           | SC_MDA00 |              | 401      | SC_MCA00  |              | 401        | SC_DTM00      |               | 401            |
      | ASSAY_MESSAGE_SENDER              | SC_MDA00 |              | 401      | SC_MCA00  |              | 401        | SC_DTM00      |               | 401            |
