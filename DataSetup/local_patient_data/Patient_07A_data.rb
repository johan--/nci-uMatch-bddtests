...
pt = PatientDataSet.new('PT_VC10_VRUploaded_DiffSEI_DiffMOI')
...
pt = PatientDataSet.new('PT_VC10_VRUploaded_DiffSEI_SameMOI')
PatientMessageLoader.register_patient(pt.id)
PatientMessageLoader.specimen_received_tissue(pt.id, pt.sei)
PatientMessageLoader.specimen_shipped_tissue(pt.id, pt.sei, pt.moi)
PatientMessageLoader.variant_file_uploaded(pt.id, pt.moi, pt.ani)
PatientMessageLoader.specimen_received_tissue(pt.id, pt.sei_increase, '2016-06-25T15:17:11+00:00')
PatientMessageLoader.specimen_shipped_tissue(pt.id, pt.sei, pt.moi, '2016-07-01T19:42:13+00:00')
PatientMessageLoader.variant_file_uploaded(pt.id, pt.moi, pt.ani_increase)
...
PatientMessageLoader.specimen_shipped_slide(pt.id, pt.sei, pt.bc, '2016-05-01T19:42:13+00:00')
PatientMessageLoader.specimen_shipped_tissue(pt.id, pt.sei, pt.moi, '2016-05-01T19:48:13+00:00')
