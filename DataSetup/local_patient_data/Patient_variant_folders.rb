...
PatientVariantFolderCreator.create_default('PT_ETE03', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE05', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE06_Step2TsReceived1', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE06_Step2TsReceived2', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE06_Step2BdReceived', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE04_TsShipped', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE04_slideShipped', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE04_PathoConfirmed', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE04_TsVrConfirmed', 'tissue')
...
PatientVariantFolderCreator.create_default('PT_ETE09_OffStudy2', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE09a_OnTA1', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE09a_OnTA2', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE10', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE11_OnTreatmentArm', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE11_PendingAproval', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE11_PendingAproval', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE15_TsReceived1', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE15_TsReceived2', 'tissue')

PatientVariantFolderCreator.create_default('PT_ETE16_PendingApproval', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE16_OnTreatmentArm', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE17_PendingApproval', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE17_OnTreatmentArm', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE17_RequestNoAssignment', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE17_RequestAssignment', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE17_TsShipped', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE17_slideShipped', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE17_PathoConfirmed', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE17_TsVrConfirmed', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE17_TsVrRejected', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE18_PendingApproval', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE18_OnTreatmentArm', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE18_RequestNoAssignment', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE18_RequestAssignment', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE18_TsShipped', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE18_slideShipped', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE18_PathoConfirmed', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE18_TsVrConfirmed', 'tissue')
PatientVariantFolderCreator.create_default('PT_ETE18_TsVrRejected', 'tissue')
