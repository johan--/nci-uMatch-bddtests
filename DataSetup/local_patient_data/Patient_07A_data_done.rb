...
class Patient07A
  ...
  def self.pt_rb02a_pending_confirmation
    pt = PatientDataSet.new('PT_RB02a_PendingConfirmation')
    PatientMessageLoader.register_patient(pt.id)
    PatientMessageLoader.specimen_received_tissue(pt.id, pt.sei)
    PatientMessageLoader.specimen_shipped_tissue(pt.id, pt.sei, pt.moi)
    PatientMessageLoader.specimen_shipped_slide(pt.id, pt.sei, pt.bc)
  ...
  def self.pt_rb02a_pending_approval
    pt = PatientDataSet.new('PT_RB02a_PendingApproval')
    PatientMessageLoader.register_patient(pt.id)
    PatientMessageLoader.specimen_received_tissue(pt.id, pt.sei)
    PatientMessageLoader.specimen_shipped_tissue(pt.id, pt.sei, pt.moi)
    PatientMessageLoader.specimen_shipped_slide(pt.id, pt.sei, pt.bc)
  ...
  def self.pt_rb02a_pend_appr3_assigns
    pt = PatientDataSet.new('PT_RB02a_PendAppr3Assigns')
