...
tag = 'patients'
MatchTestDataManager.delete_patients_from_seed(%w(PT_SC04e_TsVrUploaded))
...
Patient5xA.upload_patient('PT_SC04e_TsVrUploaded1')
Patient5xA.upload_patient('PT_SC04e_TsVrUploaded2')
sleep 10.0
