...
PedMatchTestData.clear_and_initial_all('ui')
...
pt_list << 'PT_CR01_PathAssayDoneVRUploadedToConfirm'
pt_list << 'PT_CR02_OnTreatmentArm'
pt_list << 'PT_CR03_VRUploadedPathConfirmed'
pt_list << 'PT_CR04_VRUploadedAssayReceived'
pt_list << 'PT_CR06_RejectOneVariant'
pt_list << 'PT_CR07_RejectVariantReport'
pt_list << 'PT_CR08_BloodSpecimenUploaded'
pt_list << 'UI_PA08_MdaTsVrUploaded'
pt_list << 'UI_PA08_MochaTsVrUploaded'
pt_list << 'UI_PA08_PendingConfirmation'
pt_list << 'UI_MA_PendingApproval'
pt_list << 'TA_AS40_TsVrReceived'
pt_list << 'UL_CM01_TsShipped'
pt_list << 'UL_CM02_TsShipped'

SeedFile.copy_patients_between_tags(pt_list.uniq, 'patients', 'ui')
