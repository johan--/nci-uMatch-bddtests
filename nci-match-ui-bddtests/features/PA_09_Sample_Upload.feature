...
Feature: MATCHKB-542. Users can upload patient sample files.
  ...
  Scenario Outline: As a privileged user I can upload a sample file
    ...
    Examples:
      ...
      | VR_Reviewer_mda   | PT_AU04_MdaTsShipped1   | Surgical Event PT_AU04_MdaTsShipped1_SEI1   | mda - IR_MDA05   | PT_AU04_MdaTsShipped1_An123   | mda_small.vcf   |
      | VR_Reviewer_mocha | PT_AU04_MochaTsShipped1 | Surgical Event PT_AU04_MochaTsShipped1_SEI1 | mocha - IR_MCA00 | PT_AU04_MochaTsShipped1_An123 | mocha_small.vcf |
