...
class BddUploader
  ...
  private_class_method def self.generate_html(json_folder, level, tag, date)
  ...
  private_class_method def self.convert_html(report_path, date)
  ...
  private_class_method def self.upload_report(report_folder, report_file_name, date, s3_bucket)
...
BddUploader.clean_json_files('/Users/wangl17/match_apps/nci-uMatch-bddtests/results')